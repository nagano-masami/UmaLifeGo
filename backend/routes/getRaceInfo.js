...
raceInfo = [{
  ...
  // // データを取り出す
  // connection.query(config.getRaceInfoSQL, [defaultBar.selectDate,defaultBar.selectPlace,defaultBar.selectRace_no],function (error, results, fields) {
